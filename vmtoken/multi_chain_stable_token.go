...
// MultiChainStableToken extends BasicToken with multi-chain stable token functionality
type MultiChainStableToken struct {
	*BasicToken
...
// NewMultiChainStableToken creates a new multi-chain stable token VM
func NewMultiChainStableToken(info schema.Info, owner string, mintOwner string, burnFees map[string]*big.Int, feeRecipient string, burnProcessor string) *MultiChainStableToken {
	return &MultiChainStableToken{
...
// SpawnMultiChainStableToken spawns a multi-chain stable token VM with multi-chain support
func SpawnMultiChainStableToken(env vmmSchema.Env) (vm vmmSchema.Vm, err error) {
	...
	vm = NewMultiChainStableToken(schema.Info{
		Id:       env.Id,
...
func (v *MultiChainStableToken) CacheTokenInfo() map[string]string {
...
func (v *MultiChainStableToken) Apply(from string, meta vmmSchema.Meta) (res *vmmSchema.Result, err error) {
	switch meta.Action {
	case "Info":
...
func (v *MultiChainStableToken) Checkpoint() (data string, err error) {
	snap := schema.MultiChainStableSnapshot{
...
func (v *MultiChainStableToken) Restore(data string) error {
	snap := &schema.MultiChainStableSnapshot{}
...
func (v *MultiChainStableToken) HandleInfo(from string) (res *vmmSchema.Result, err error) {
...
func (v *MultiChainStableToken) HandleSetParams(from string, meta vmmSchema.Meta) (res *vmmSchema.Result, applyErr error) {
	var err error
	defer func() {
		if err != nil {
			if res == nil {
	...
	// Handle source token chain mappings
	if sourceTokenChainsStr, exists := meta.Params["SourceTokenChains"]; exists && sourceTokenChainsStr != "" {
		var sourceTokenChains map[string]string
		if err = json.Unmarshal([]byte(sourceTokenChainsStr), &sourceTokenChains); err == nil {
			v.SourceTokenChains = sourceTokenChains
		}
	}
...
func (v *MultiChainStableToken) HandleCrossChainMint(from string, params map[string]string) (res *vmmSchema.Result, applyErr error) {
	var err error
	defer func() {
		if err != nil {
			if res == nil {
...
func (v *MultiChainStableToken) HandleCrossChainBurn(from string, params map[string]string) (res *vmmSchema.Result, applyErr error) {
	var err error
	defer func() {
		if err != nil {
			if res == nil {
...
func (v *MultiChainStableToken) crossChainBurn(from string, amount *big.Int,
